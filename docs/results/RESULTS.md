...
```
Ііі у захваті від виконаної роботи, доповідаємо Ромі, що тепер можна результати компіляції програм з Clojure можна скармлювати емулятору процесора, і перевіряти правильність стану процесора.
